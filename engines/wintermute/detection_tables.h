...
static const WMEGameDescription gameDescriptions[] = {
	...
	WME_WINENTRY("chivalry", "", 
		WME_ENTRY1s("data.dcp", "ebd0915d9a12df5224be22f53bb23eb6", 7278306), Common::EN_ANY, ADGF_UNSTABLE, LATEST_VERSION),
	// Chivalry is Not Dead (Version from deirdrakai.com)
	WME_WINENTRY("chivalry", "", 
		WME_ENTRY1s("data.dcp", "ae6d91b9517f4d2851a8ad94c96951c8", 7278302), Common::EN_ANY, ADGF_UNSTABLE, LATEST_VERSION),
	// Conspiracao Dumont
	...
	WME_WINENTRY("corrosion", "", 
		WME_ENTRY1s("data.dcp", "ae885b1a8faa0b27f43c0e8f0df02fc9", 525931618), Common::EN_ANY, ADGF_UNSTABLE, LATEST_VERSION),
	// Dead City (Czech)
