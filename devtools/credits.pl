...
begin_credits("Credits");
	...
	begin_section("Former ScummVM Team");
		add_paragraph(
			"For other people that have contributed to the project, see COPYRIGHT.");

		add_paragraph(
			"Of note, the Cabal team would like to thank Torbjorn Andersson, ".
			...
			"Ludvig Strigeus, Julien Templier, Tobia Tesan, David Turner, and ".
			"Walter van Niftrik.");

		add_paragraph(
			"Without these people, ScummVM would have been much worse off and Cabal ".
