...
"",
"C0""For other people that have contributed to the project, see COPYRIGHT.",
"C0""",
"C0""Of note, the Cabal team would like to thank Torbjorn Andersson, Ori Avtalion, Fabio Battaglia, James Brown, Bastien Bouclet, Sylvain Dupont, Oystein Eftevaag, Vincent Hamm, Sven Hesse, Max Horn, Travis Howell, Keith Kaisershot, Florian Kagerer, Pawel Kolodziejski, Vicent Marti, Alyssa Milburn, Gregory Montoir, Willem Jan Palenstijn, peres, Joost Peters, Jordi Vilalta Prat, Quietust, Johannes Schickel, Lars Skovlund, Einar Johan T. Somaaen, Ludvig Strigeus, Julien Templier, Tobia Tesan, David Turner, and Walter van Niftrik.",
"C0""",
"C0""Without these people, ScummVM would have been much worse off and Cabal wouldn't exist today.",
"C0""",
"",
